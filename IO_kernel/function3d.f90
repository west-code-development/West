...
MODULE function3d
 ...
 INTERFACE write_function3d
    MODULE PROCEDURE write_function3d_real,write_function3d_real_onroot !, write_function3d_complex
 END INTERFACE
 !
 INTERFACE read_function3d
    MODULE PROCEDURE read_function3d_real,read_function3d_real_onroot !, read_function3d_complex
 END INTERFACE
 !
 CONTAINS
 !
 ...
 !
  !-----------------------------------------------------------------
   SUBROUTINE write_function3d_real_onroot ( fname, f_r, dfft, onroot )
   ! -----------------------------------------------------------------
   !
   USE kinds,                       ONLY : DP
   USE cell_base,                   ONLY : celldm, at
 ...
 !
  !-----------------------------------------------------------------
   SUBROUTINE read_function3d_real_onroot ( fname, f_r, dfft, onroot )
   ! -----------------------------------------------------------------
   !
   USE kinds,                       ONLY : DP
   USE cell_base,                   ONLY : celldm, at
