...
def test_beta():
    ...
    ref_beta = read_beta_from_json("./test018/ref/wbse.json")
    test_beta = read_beta_from_json("./test018/test.wbse.save/wbse.json")
...
def test_zeta():
    ...
    ref_zeta = read_zeta_from_json("./test018/ref/wbse.json")
    test_zeta = read_zeta_from_json("./test018/test.wbse.save/wbse.json")
